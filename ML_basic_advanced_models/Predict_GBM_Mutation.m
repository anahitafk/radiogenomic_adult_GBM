...
All_Features_replication2 = All_Features_replication(:,SelectedModel.selected_ranking);
...
[~,score_rep] = predict(ScoreSVMModel,All_Features_replication2);


sscore_rep = score_rep(:,2);


ROCout_rep = roc_dnafinder([sscore_rep,class_replication],0,0.05,0);
